...
class Mision3E1B(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Transmisor Laboratorio", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transmisor Laboratorio")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Mision3E1B")
        ...
        self.KA = KA = 1
        self.GTX = GTX = 20
        self.Frecuencia = Frecuencia = 500
        self.Am = Am = 1
        self.Ac = Ac = 0.25
        ...
        self._KA_range = qtgui.Range(0, 3, 0.1, 1, 200)
        ...
        self._Frecuencia_range = qtgui.Range(100, 20000, 100, 500, 200)
        ...
        self._Am_range = qtgui.Range(0, 1, 0.1, 1, 200)
        ...
        self._Ac_range = qtgui.Range(0, 0.5, 0.01, 0.25, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, Frecuencia, Am, 0, 0)
    ...
    def set_fc(self, fc):
        self.fc = fc
        self.qtgui_waterfall_sink_x_0.set_frequency_range((self.fc*1e6), 125000000)
...
def main(top_block_cls=Mision3E1B, options=None):
